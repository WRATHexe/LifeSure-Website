...
const CustomerDashboardLayout = () => {
  ...
  useEffect(() => {
    if (!isLoading && userProfile && userProfile.user?.role !== "customer") {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      >
        {/* Logo & Brand */}
        <div className="flex items-center justify-between h-20 px-6 bg-gradient-to-r from-teal-600 via-teal-700 to-teal-800 shadow-lg">
          <Link to="/" className="flex items-center group">
            ...
            <div>
              ...
              <span className="text-teal-200 text-xs">Customer Dashboard</span>
            </div>
          </Link>
          <button
            onClick={() => setSidebarOpen(false)}
        ...
        <div className="p-6 bg-gradient-to-b from-teal-50 to-white border-b border-gray-200">
          <div className="flex items-center">
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full border-2 border-white bg-teal-500"></div>
            </div>
            <div className="ml-4 flex-1">
              ...
              <div className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium mt-1 bg-teal-100 text-teal-800">
                Customer
              </div>
            </div>
          </div>
        ...
        <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          ...
          <div className="pt-8">
            ...
            <div className="space-y-2">
              <Link
                to="/"
                className="group flex items-center px-4 py-2 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-50 hover:text-teal-700 transition-colors duration-200"
                onClick={() => setSidebarOpen(false)}
              >
                <FaHome className="mr-3 w-4 h-4 text-gray-400 group-hover:text-teal-600" />
                Back to Website
              </Link>
            </div>
          </div>
        ...
        <header className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-30">
          <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link
                to="/"
                className="hidden lg:flex items-center px-3 py-2 text-sm font-medium text-gray-600 hover:text-teal-600 hover:bg-teal-50 rounded-lg transition-colors duration-200"
              >
