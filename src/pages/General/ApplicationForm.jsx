              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-3">
                  <input
                    ...
                    className="w-4 h-4 text-blue-600 border-gray-300 rounded"
                  />
                  <label className="text-sm text-gray-700">Do you smoke?</label>
                </div>
            ...
            <div className="bg-white rounded-lg shadow p-8">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-start space-x-3">
                  <input
                    type="checkbox"
                    {...register("declarations.truthfulInfo", {
                      required: "You must confirm the information is truthful",
                    })}
                ...
                {errors.declarations?.truthfulInfo && (
                  <p className="text-red-600 text-sm ml-7">
                    {errors.declarations.truthfulInfo.message}
                  </p>
                )}
                ...
                <div className="flex items-start space-x-3">
                  <input
                    type="checkbox"
                    {...register("declarations.termsAccepted", {
                ...
                {errors.declarations?.termsAccepted && (
                  <p className="text-red-600 text-sm ml-7">
                    {errors.declarations.termsAccepted.message}
                  </p>
                )}
              </div>
            </div>
